                    ...
                    <div class="footer-heading-1">
                        <h2>Our Company</h2>
                            <ul class="footer-list1">
                                <li><a href="#aboutUs" class="hyperlink1">About Us</a></li>
                                <li><a href="#" class="hyperlink1">Terms & Conditions</a></li>
                                <li><a href="#" class="hyperlink1">Privacy Policy</a></li>
                                <li><a href="#" class="hyperlink1">Career</a></li>
                            </ul>
                    </div>
                        ...
                        <div>
                            <h2>Find us on: </h2>
                                <ul class="footer-list4">
                                    ...
                                    <li><a href="https://tiktok.com/" target="_blank"><i class="fab fa-tiktok fa-2x" aria-hidden="true"></i></a></li>
                                    <li><a href="https://facebook.com/" target="_blank"><i class="fa-brands fa-facebook fa-2x" aria-hidden="true"></i></a></li>
                                    <li><a href="https://youtube.com/" target="_blank"><i class="fa-brands fa-youtube fa-2x" aria-hidden="true"></i></a></li>
                                </ul>
                        </div>
                    </div>
                </div>
